...
public class ListHomeFragment extends Fragment implements RecyclerviewListCategoryAdapter.onClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        switch (number) {
            case 0:
                imgTitle.setImageResource(R.drawable.ic_baseline_discount_24);
                categoryTitle.setText("Discount");
                category.setBackgroundColor(getResources().getColor(R.color.ListHomeTitle));
                ...
                break;
            case 1:
                imgTitle.setImageResource(R.drawable.ic_baseline_star_24);
                categoryTitle.setText("Popular");
                category.setBackgroundColor(getResources().getColor(R.color.ListHomeTitle));
