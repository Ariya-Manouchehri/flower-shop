...
public class RecyclerViewRecentlyAdapter extends RecyclerView.Adapter<RecyclerViewRecentlyAdapter.Holder> {
    Context context;
    ArrayList<Flower> flowers;

    public RecyclerViewRecentlyAdapter(Context context, ArrayList<Flower> flowers) {
